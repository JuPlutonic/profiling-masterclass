...
class TestMe < Minitest::Test
  ...
  def test_result
    ReportBuilderSlow.new.call('data_18.txt', 'result_small_minitest.json')
    ...
    assert_equal expected_result, JSON.parse(File.read('payloads/result_small_minitest.json'))
  end
end
